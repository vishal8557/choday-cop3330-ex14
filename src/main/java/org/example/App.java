...
public class App {
    public static void main(String[] args) {
        ...
        String thestate = input.nextLine();

        if (thestate.equals("WI")){
            double THE_SUBTOTAL;
            double THE_TAXES;
            THE_SUBTOTAL = Double.parseDouble(amount);
            THE_TAXES =  THE_SUBTOTAL *(5.5 / 100);
            System.out.printf("The subtotal is $%.2f.\nThe tax is $%.2f.\nThe total is $%.2f.", THE_SUBTOTAL, THE_TAXES, THE_SUBTOTAL + THE_TAXES);
        }
    }
}
